...
<!--      <svg t="1657183230699" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2415" width="35"-->
<!--           height="35">-->
<!--        <path-->
...
<!--            p-id="2416" fill="#515151"></path>-->
<!--      </svg>-->
<!--      <span class="text-lg font-semibold flex items-center ml-3">组件</span>-->
<!--    </div>-->
    <div class="space-y-4 element-box" @dragstart="handleDragStart">
      <a-button class="cursor-move" @dblclick="handleDblClick(item.label)" type="primary" v-for="(item,index) in list" :draggable="true" :data-index="index" :key="index">{{ item.label }}</a-button>
    </div>
  </div>
</template>
