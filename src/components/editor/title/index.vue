<template>
  <div class="h-full flex justify-start items-center pl-16 ">
    <div class="cursor-pointer" @click="handleGotoProduct">
      ...
      <div class="w-full text-2xl text-white font-semibold"><span>{{store.product.title}}</span></div>
  </div>
</template>
