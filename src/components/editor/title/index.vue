<template>
  <div class="h-full flex justify-start items-center pl-10">
    <div class="cursor-pointer flex items-center title-box"  @click="handleGotoProduct">
      <svg t="1657011633371" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2233" width="32" height="32">
        <path
            ...
            p-id="2234" fill="#ffffff"></path>
      </svg>
      <div class="mx-4 w-1 h-7 border-r border-gray-400"></div>
      <span class="block w-20 text-gray-100  text-left">回到首页</span>
    </div>
    <div class="text-2xl text-white font-semibold"  style="width: 68vw"><span>{{ store.product.title }}</span></div>
  </div>
</template>
